...
function summarizeParsed(data: ParsedResumeData | undefined): string {
  ...
  if (data.languages?.length) parts.push(`外语能力 ${data.languages.length} 条`);
      ...
      <div className="options-content">
        <nav className="options-tabs" aria-label="设置分类">
          ...
          <button
            ...
            className={activeTab === 'languages' ? 'options-tab active' : 'options-tab'}
          >
            外语能力
          </button>
          <button
          ...
          <button
            ...
            className={activeTab === 'mail' ? 'options-tab active' : 'options-tab'}
          >
            邮箱监控
          </button>
          <button
        ...
        <div className="options-panel">
            ...
            <div className="options-form">
              ...
              <div style={styles.formRow}>
                <div style={{ ...styles.formGroup, flex: '0 0 150px' }}>
                  <label style={styles.label}>手机号国家区号</label>
                  <input
                    type="text"
                    value={profile.personal.phoneCountryCode || '+86'}
                    onChange={(e) => handlePersonalChange('phoneCountryCode', e.target.value)}
                    style={styles.input}
                    placeholder="如 +86"
                  />
                </div>
              ...
              <div style={styles.formRow}>
                <div style={styles.formGroup}>
                  <label style={styles.label}>证件类型</label>
                  <select
                    value={profile.personal.idType || '身份证'}
                    onChange={(e) => handlePersonalChange('idType', e.target.value)}
                    style={styles.input}
                  >
                ...
                <div style={styles.formGroup}>
                  <label style={styles.label}>证件号码</label>
                  <input
                    type="text"
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>国籍 / 地区</label>
                <input
                  type="text"
              ...
              <div className="info-note">
                ...
                身份证号默认仅保存在本地；主动使用 AI 填写证件字段时，会发送给你配置的模型服务。
              </div>
            </div>
          )}
          ...
          {activeTab !== 'ai' && activeTab !== 'mail' && activeTab !== 'data-sync' && activeTab !== 'application-records' && (
