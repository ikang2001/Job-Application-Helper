    ...
    <div>
      ...
      {items.map((item, index) => (
        <div key={item.id || index} style={styles.card}>
          ...
          <div style={styles.row}>
            <div style={styles.group}>
              <label style={styles.label}>学校所在国家 / 地区</label>
              <input
                type="text"
                value={item.countryRegion || ''}
                onChange={e => update(index, 'countryRegion', e.target.value)}
                style={styles.input}
                placeholder="如 中国"
              />
            </div>
            <div style={styles.group}>
              <label style={styles.label}>学校所在地（省 / 市 / 区县）</label>
              <input
                type="text"
                value={item.schoolLocation || ''}
                onChange={e => update(index, 'schoolLocation', e.target.value)}
                style={styles.input}
                placeholder="如 陕西省西安市长安区；网页为下拉时会逐级选择"
              />
            </div>
            <div style={styles.group}>
